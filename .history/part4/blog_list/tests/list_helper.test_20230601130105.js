...
describe('Author with the most blogs', () => {
  ...
  test('should return the author of the only blog when one blog is present', () => {    const result = listHelper.mostBlogs(helper.listWithOneBlog)
    const expected = {
      author: helper.listWithOneBlog[0].author,
      blogs: 1,
    }
  ...
  test('should return the author with most blogs when multiple blogs are present', () => {    const result = listHelper.mostBlogs(helper.listWithMultipleBlogs)
    const expected = {
