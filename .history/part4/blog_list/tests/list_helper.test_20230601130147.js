...
describe('Author with the most likes', () => {
  ...
  test('should return the author of the only blog when one blog is present', () => {    const result = listHelper.mostLikes(helper.listWithOneBlog)
    const expected = {
      author: helper.listWithOneBlog[0].author,
      likes: helper.listWithOneBlog[0].likes,
    }
  ...
  test('should return the author with most likes when multiple blogs are present', () => {    const result = listHelper.mostLikes(helper.listWithMultipleBlogs)
    const expected = {
